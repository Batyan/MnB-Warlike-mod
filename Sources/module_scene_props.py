...
scene_props = [
  ...
  ("light",sokf_invisible,"light_sphere","0",  [
     (ti_on_init_scene_prop,
      [
          ...
          (prop_instance_get_scale, pos5, ":prop_instance_no"),
          (position_get_scale_x, ":scale", pos5),
          (store_mul, ":red", 3 * 190, ":scale"),
          (store_mul, ":green", 3 * 135, ":scale"),
          (store_mul, ":blue", 3 * 35, ":scale"),
          (val_div, ":red", 100),
          (val_div, ":green", 100),
          (val_div, ":blue", 100),
          (set_current_color,":red", ":green", ":blue"),
  ...
  ("snowy_village_stable_a",0,"village_snowy_stable_a","bo_village_snowy_stable_a", []),
  ...
  ("castle_a_battlement_a_large",0,"battlement_a","bo_battlement_a", []),

  ("castle_a_battlement_a_large_destroyed",0,"battlement_a_destroyed","bo_battlement_a_destroyed", []),


  ("castle_a_round_tower_a",0,"round_tower_a","bo_round_tower_a", []),
  ("castle_a_small_round_tower_a",0,"small_round_tower_a","bo_small_round_tower_a", []),
  ("castle_a_small_round_tower_roof_a",0,"small_round_tower_roof_a","bo_small_round_tower_roof_a", []),
  ("castle_a_square_keep_a",0,"square_keep_a","bo_square_keep_a", []),
  ("castle_a_square_tower_roof_a",0,"square_tower_roof_a","0", []),
  ("castle_a_gate_house_a",0,"gate_house_a","bo_gate_house_a", []),
  ("castle_a_gate_house_b",0,"gate_house_b","bo_gate_house_b", []),
  ("small_wall_a",0,"small_wall_a","bo_small_wall_a", []),
  ("castle_g_small_wall",0,"small_wall_b","bo_small_wall_b", []),
  ("small_wall_c",0,"small_wall_c","bo_small_wall_c", []),
  ("small_wall_c_destroy",0,"small_wall_c_destroy","bo_small_wall_c_destroy", []),
  ("castle_h_small_wall",0,"small_wall_d","bo_small_wall_d", []),
  ...
  ("castle_earth_wall_a",0,"earth_wall_a","bo_earth_wall_a", []),
  ("castle_earth_wall_a2",0,"earth_wall_a2","bo_earth_wall_a2", []),
  ("castle_earth_wall_b",0,"earth_wall_b","bo_earth_wall_b", []),
  ("castle_earth_wall_b2",0,"earth_wall_b2","bo_earth_wall_b2", []),
  ("castle_earth_stairs_a",sokf_type_ladder,"earth_stairs_a","bo_earth_stairs_a", []),
  ("castle_earth_stairs_b",sokf_type_ladder,"earth_stairs_b","bo_earth_stairs_b", []),
  ("castle_earth_tower_small_a",0,"earth_tower_small_a","bo_earth_tower_small_a", []),
  ("castle_earth_gate_house_a",0,"earth_gate_house_a","bo_earth_gate_house_a", []),
  ("castle_earth_gate_a",0,"earth_gate_a","bo_earth_gate_a", []),
  ("castle_earth_square_keep_a",0,"earth_square_keep_a","bo_earth_square_keep_a", []),
  ("castle_earth_house_a",0,"earth_house_a","bo_earth_house_a", []),
  ("castle_earth_house_b",0,"earth_house_b","bo_earth_house_b", []),
  ("castle_earth_house_c",0,"earth_house_c","bo_earth_house_c", []),
  ("castle_earth_house_d",0,"earth_house_d","bo_earth_house_d", []),
  ...
  ("castle_snowy_battlement_tower_a",0,"snowy_castle_tower_a","bo_snowy_castle_tower_a", []),
  ("castle_snowy_battlement_a",0,"snowy_castle_battlement_a","bo_snowy_castle_battlement_a", []),
  ("castle_snowy_battlement_a_destroyed",0,"snowy_castle_battlement_a_destroyed","bo_snowy_castle_battlement_a_destroyed", []),
 
  ("castle_snowy_battlement_b",0,"snowy_castle_battlement_b","bo_snowy_castle_battlement_b", []),
  ("castle_snowy_battlement_corner_a",0,"snowy_castle_battlement_corner_a","bo_snowy_castle_battlement_corner_a", []),
  ("castle_snowy_battlement_corner_b",0,"snowy_castle_battlement_corner_b","bo_snowy_castle_battlement_corner_b", []),
  ("castle_snowy_battlement_corner_c",0,"snowy_castle_battlement_corner_c","bo_snowy_castle_battlement_corner_c", []),
  ("castle_snowy_battlement_stairs_a",sokf_type_ladder,"snowy_castle_battlement_stairs_a","bo_snowy_castle_battlement_stairs_a", []),
  ("castle_snowy_battlement_stairs_b",sokf_type_ladder,"snowy_castle_battlement_stairs_b","bo_snowy_castle_battlement_stairs_b", []),
  ("castle_snowy_battlement_gate_house_a",0,"snowy_castle_gate_house_a","bo_snowy_castle_gate_house_a", []),
  ("castle_snowy_battlement_round_tower_a",0,"snowy_castle_round_tower_a","bo_snowy_castle_round_tower_a", []),
  ("castle_snowy_battlement_square_keep_a",0,"snowy_castle_square_keep_a","bo_snowy_castle_square_keep_a", []),
  ("castle_snowy_battlement_new_a",0,"gatehouse_new_snowy_a","bo_gatehouse_new_b", []),
  ...
  ("castle_a_gatehouse_b",0,"gatehouse_b","bo_gatehouse_b", []),
  ("castle_a_gaillard",0,"castle_gaillard","bo_castle_gaillard", []),
  ...
  ("castle_snowy_battlement_courtyard_gate",0,"courtyard_entry_snowy","bo_courtyard_entry_a", []),

  ("castle_a_tower_a",0,"castle_tower_a","bo_castle_tower_a", []),
  ("castle_a_battlement_a",0,"castle_battlement_a","bo_castle_battlement_a", []),
  ("castle_a_battlement_b",0,"castle_battlement_b","bo_castle_battlement_b", []),
  ("castle_a_battlement_c",0,"castle_battlement_c","bo_castle_battlement_c", []),

  ("castle_a_battlement_a_destroyed",0,"castle_battlement_a_destroyed","bo_castle_battlement_a_destroyed", []),
  ("castle_a_battlement_b_destroyed",0,"castle_battlement_b_destroyed","bo_castle_battlement_b_destroyed", []),

  ("castle_a_battlement_corner_a",0,"castle_battlement_corner_a","bo_castle_battlement_corner_a", []),
  ("castle_a_battlement_corner_b",0,"castle_battlement_corner_b","bo_castle_battlement_corner_b", []),
  ("castle_a_battlement_corner_c",0,"castle_battlement_corner_c","bo_castle_battlement_corner_c", []),
  ("castle_a_battlement_stairs_a",0,"castle_battlement_stairs_a","bo_castle_battlement_stairs_a", []),
  ("castle_a_battlement_stairs_b",0,"castle_battlement_stairs_b","bo_castle_battlement_stairs_b", []),
  ("castle_a_gate_house_a",0,"castle_gate_house_a","bo_castle_gate_house_a", []),
  ("castle_a_round_tower_a",0,"castle_round_tower_a","bo_castle_round_tower_a", []),
  ("castle_a_square_keep_a",0,"castle_square_keep_a","bo_castle_square_keep_a", []),
  ("castle_a_stairs_a",sokf_type_ladder,"castle_stairs_a","bo_castle_stairs_a", []),

  ("castle_a_drawbridge_open",0,"castle_drawbridges_open","bo_castle_drawbridges_open", []),
  ("castle_a_drawbridge_closed",0,"castle_drawbridges_closed","bo_castle_drawbridges_closed", []),
 ...
 ("castle_g_small_wall_connect",0,"small_wall_connect_a","bo_small_wall_connect_a", []),
 ...
 ("castle_earth_tower_small_b",0,"earth_tower_small_b","bo_earth_tower_small_b", []),
 ("castle_earth_gate_house_b",0,"earth_gate_house_b","bo_earth_gate_house_b", []),
 ("castle_earth_tower_a",0,"earth_tower_a","bo_earth_tower_a", []),
 ("castle_earth_stairs_c",0,"earth_stairs_c","bo_earth_stairs_c", []),
