...
game_menus = [
    ...
    ("town_keep", mnf_scale_picture,
        ...
        [
            ...
            ("center_meet_npc", [], "Meet with someone",
                [
                    (jump_to_menu, "mnu_town_meet_npc"),
                ]),
    ...
    ("town_meet_npc", mnf_scale_picture,
        "Who are you meeting? (page {reg10}/{reg11})",
        "none",
        [
            (assign, ":num_npcs", 0),
            (try_for_range, ":npc", npc_heroes_begin, npc_heroes_end),
                (call_script, "script_cf_troop_is_in_center", ":npc", "$g_encountered_party"),
                (val_add, ":num_npcs", 1),
            (try_end),
            (val_sub, ":num_npcs", 1),

            (store_div, ":num_pages", ":num_npcs", 5),
            (val_add, ":num_pages", 1),
            (try_begin),
                (neg|is_between, "$g_town_visit_npc_current_page", 0, ":num_pages"),
                (assign, "$g_town_visit_npc_current_page", 0),
            (try_end),
            (store_add, reg10, "$g_town_visit_npc_current_page", 1),
            (assign, reg11, ":num_pages"),
        ],
        [
            ("option_1",
                [
                    (store_mul, ":num_skips", "$g_town_visit_npc_current_page", 5),
                    (assign, ":end", npc_heroes_end),
                    (assign, ":found", -1),
                    (try_for_range, ":npc", npc_heroes_begin, ":end"),
                        (call_script, "script_cf_troop_is_in_center", ":npc", "$g_encountered_party"),
                        (try_begin),
                            (gt, ":num_skips", 0),
                            (val_add, ":num_skips", -1),
                        ...
                        (try_end),
                    (try_end),
                    (is_between, ":found", npc_heroes_begin, npc_heroes_end),
                ...
                [
                    ...
                    (try_end),
                    (is_between, ":found", npc_heroes_begin, npc_heroes_end),
                    (call_script, "script_setup_troop_meeting", ":found", -1),
                ]),
            ("option_2",
                [
                    (store_mul, ":num_skips", "$g_town_visit_npc_current_page", 5),
            ...
            ("option_next",
                [], "Next page",
                [
                    (val_add, "$g_town_visit_npc_current_page", 1),
                    (jump_to_menu, "mnu_town_meet_npc"),
                ]),
            ("option_previous",
                [], "Previous page",
