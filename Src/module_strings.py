...
strings = [
 ...
 or honour the name that you can no longer bear to speak..."),
  ...
  ("attribute_charisma_description", "Each point increases your party morale by +1 and increases the amount of shared experience gained after combat by 2%. The following skills can not be developed beyond 1/3 of Charisma: Persuasion, Prisoner Management, Leadership, Trade"),
  ...
  ("skill_tactics_description","Every two levels of this skill increases starting battle advantage by 1, also increases party morale. (Party skill)"),
  ...
  ("skill_trainer_2_description","This skill helps you train and recruit new troops more quickly for a lower price. Trains hero companions' weapon proficiencies. (Personal skill)"),
