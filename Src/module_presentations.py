    ...
    ("recruit_from_town_garrison", 0, mesh_load_window, 
        [
        	...
        	[
                ...
                # Grants
                (try_begin),
                    (neq, ":current_city", "p_recruit_mercenaries"),
                    (assign, ":x", 630),
                    ...
                    (else_try),
                        ...
                        (call_script, "script_troop_get_center_recruit_grants_center_relation", "$g_player_troop", ":current_city"),
                        (assign, ":num_grants", reg0),
                        (str_store_string_reg, s10, s0),
        ...
        [
            ...
            [
                ...
                (else_try),
                    ...
                    (val_sub, ":total_change", ":player_party_wages"),
                    (val_sub, ":total_change", ":unpaid_wages"),
                    ...
                    (store_mul, "$g_presentation_wages_amount_unpaid", ":total_change", -1),
                (else_try),
    ...
    ("center_administration", 0, mesh_load_window,
        [
            ...
            [
                ...
                (party_get_slot, ":governor", ":current_center", slot_party_governor),
                (try_begin),
                    (this_or_next|eq, ":lord", "$g_player_troop"),
                    (eq, ":governor", "$g_player_troop"),
                ...
                (try_begin),
                    ...
                    (create_game_button_overlay, reg0, "@Change governor"),
                    (store_add, ":x", ":right_panel_x", 100),
                    (position_set_x, pos1, ":x"),
                    (position_set_y, pos1, ":cur_y"),
                    (overlay_set_position, reg0, pos1),
                    (val_add, ":cur_y", ":line_height"),
                    (assign, "$g_presentation_center_change_governor", reg0),
                (try_end),
                (val_add, ":cur_y", ":line_height"),
                ...
                (call_script, "script_presentation_create_text_overlay", tf_left_align, ":left_panel_x", ":cur_y", 1000, 1000),
                (str_store_string, s10, "@Current governor:"),
                (call_script, "script_presentation_create_text_overlay", tf_left_align, ":right_panel_x", ":cur_y", 1000, 1000),
                (val_add, ":cur_y", ":line_height"),
            ...
            [
                ...
                (else_try),
                    (eq, ":object", "$g_presentation_center_change_governor"),
                    (assign, "$callback", "script_assign_selected_governor"),
                    (assign, "$temp", ":current_center"),
                    (assign, "$filter_method", "script_filter_governor_candidate"),
        ...
        [
                ...
                [
                    ...
                    (try_for_range_backwards, ":cur_center", centers_begin, centers_end),
                        ...
                        (try_begin),
                            ...
                            (store_sub, ":offset", ":lord", npc_heroes_begin),
                        ...
                        (try_end),
                        (try_begin),
                            (is_between, ":governor", npc_heroes_begin, npc_heroes_end),
                            (store_sub, ":offset", ":governor", npc_heroes_begin),

                            (store_sub, ":count", npc_heroes_end, npc_heroes_begin),
                            (store_add, ":slot", ":offset", ":count"),
                            (val_add, ":slot", 2),
                            (troop_set_slot, "trp_temp_troop", ":slot", 0),
                        (else_try),
                            (eq, ":governor", "$g_player_troop"),
                            (store_sub, ":slot", npc_heroes_end, npc_heroes_begin),
                            (val_add, ":slot", 1),
                            (troop_set_slot, "trp_temp_troop", ":slot", 0),
                        (try_end),

                        (party_get_slot, ":party_type", ":cur_center", slot_party_type),
                        (this_or_next|eq, "$g_filter_center", filter_any),
                        (eq, "$g_filter_center", ":party_type"),

                        (this_or_next|eq, "$g_filter_lord", filter_any),
                        (eq, "$g_filter_lord", ":lord"),

                        (this_or_next|eq, "$g_filter_governor", filter_any),
                        (eq, "$g_filter_governor", ":governor"),
                    ...
                    # Filters
                    (assign, ":filter_buttons_x", 550),
                    (assign, ":filter_labels_x", 350),

                    (assign, ":center_type_y", 80),
                    (assign, ":owner_y", 60),
                    (assign, ":governor_y", 40),

                    (str_store_string, s10, "@Filters"),
                    (call_script, "script_presentation_create_text_overlay", 0, ":filter_labels_x", 110, 1000, 1000),

                    (str_store_string, s10, "@Center type"),
                    (call_script, "script_presentation_create_text_overlay", 0, ":filter_labels_x", ":center_type_y", 800, 800),
                    (str_store_string, s10, "@Owner"),
                    (call_script, "script_presentation_create_text_overlay", 0, ":filter_labels_x", ":owner_y", 800, 800),
                    (str_store_string, s10, "@Governor"),
                    (call_script, "script_presentation_create_text_overlay", 0, ":filter_labels_x", ":governor_y", 800, 800),

                    (create_combo_button_overlay, "$g_presentation_filter_center", "@Any", 0),
                    (position_set_x, pos1, ":filter_buttons_x"),
                    (position_set_y, pos1, ":center_type_y"),
                    (overlay_set_position, "$g_presentation_filter_center", pos1),
                    (position_set_x, pos1, 500),
                    (position_set_y, pos1, 500),
                    (overlay_set_size, "$g_presentation_filter_center", pos1),

                    (overlay_add_item, "$g_presentation_filter_center", "@Villages"),
                    (overlay_add_item, "$g_presentation_filter_center", "@Castles"),
                    (overlay_add_item, "$g_presentation_filter_center", "@Towns"),

                    (overlay_add_item, "$g_presentation_filter_center", "@Any"),

                    (try_begin),
                        (eq, "$g_filter_center", spt_village),
                        (overlay_set_val, "$g_presentation_filter_center", 0),
                    (else_try),
                        (eq, "$g_filter_center", spt_castle),
                        (overlay_set_val, "$g_presentation_filter_center", 1),
                    (else_try),
                        (eq, "$g_filter_center", spt_town),
                        (overlay_set_val, "$g_presentation_filter_center", 2),
                    (else_try),
                        (eq, "$g_filter_center", filter_any),
                        (overlay_set_val, "$g_presentation_filter_center", 3),
                    (try_end),

                    (create_combo_button_overlay, "$g_presentation_filter_lord", "@Any", 0),
                    (position_set_x, pos1, ":filter_buttons_x"),
                    (position_set_y, pos1, ":owner_y"),
                    (overlay_set_position, "$g_presentation_filter_lord", pos1),
                    (position_set_x, pos1, 500),
                    (position_set_y, pos1, 500),
                    (overlay_set_size, "$g_presentation_filter_lord", pos1),

                    (create_combo_button_overlay, "$g_presentation_filter_governor", "@Any", 0),
                    (position_set_x, pos1, ":filter_buttons_x"),
                    (position_set_y, pos1, ":governor_y"),
                    (overlay_set_position, "$g_presentation_filter_governor", pos1),
                    (position_set_x, pos1, 500),
                    (position_set_y, pos1, 500),
                    (overlay_set_size, "$g_presentation_filter_governor", pos1),

                    (assign, ":cur_overlay_lord_value", 0),
                    (assign, ":cur_overlay_governor_value", 0),
                    (try_for_range_backwards, ":cur_center", centers_begin, centers_end),
                        (call_script, "script_cf_clan_management_can_display_center", ":cur_center"),
                        ...
                        (try_begin),
                            ...
                            (overlay_add_item, "$g_presentation_filter_lord", s10),
                            (troop_set_slot, "trp_temp_troop", ":slot", 1),
                            (try_begin),
                                (eq, "$g_filter_lord", ":leader"),
                                (overlay_set_val, "$g_presentation_filter_lord", ":cur_overlay_lord_value"),
                            (try_end),
                            (val_add, ":cur_overlay_lord_value", 1),
                        (try_end),
                        (try_begin),
                            (ge, ":governor", 0),
                            ...
                            (str_store_troop_name, s11, ":governor"),
                            (overlay_add_item, "$g_presentation_filter_governor", s11),
                            (troop_set_slot, "trp_temp_troop", ":slot", 1),

                            (try_begin),
                                (eq, "$g_filter_governor", ":governor"),
                                (overlay_set_val, "$g_presentation_filter_governor", ":cur_overlay_governor_value"),
                            (try_end),
                            (val_add, ":cur_overlay_governor_value", 1),
                        (try_end),
                    (try_end),

                    (overlay_add_item, "$g_presentation_filter_lord", "@Any"),
                    (overlay_add_item, "$g_presentation_filter_governor", "@Any"),
                    (overlay_add_item, "$g_presentation_filter_lord", "@None"),
                    (overlay_add_item, "$g_presentation_filter_governor", "@None"),

                    (try_begin),
                        (eq, "$g_filter_lord", filter_any),
                        (assign, ":val", ":cur_overlay_lord_value"),
                        (overlay_set_val, "$g_presentation_filter_lord", ":val"),
                    (else_try),
                        (eq, "$g_filter_lord", filter_none),
                        (store_add, ":val", ":cur_overlay_lord_value", 1),
                        (overlay_set_val, "$g_presentation_filter_lord", ":val"),
                    (try_end),

                    (try_begin),
                        (eq, "$g_filter_governor", filter_any),
                        (assign, ":val", ":cur_overlay_governor_value"),
                        (overlay_set_val, "$g_presentation_filter_governor", ":val"),
                    (else_try),
                        (eq, "$g_filter_governor", filter_none),
                        (store_add, ":val", ":cur_overlay_governor_value", 1),
                        (overlay_set_val, "$g_presentation_filter_governor", ":val"),
                    (try_end),
            ...
            (ti_on_presentation_event_state_change,
                [
                    ...
                    (assign, reg10, ":value"),
                    (display_message, "@Current value: {reg10}"),
                    ...
                    (try_begin),
                        ...
                        (presentation_set_duration, 0),
                    (else_try),
                        (eq, ":object", "$g_presentation_filter_center"),
                        (assign, "$g_filter_center", ":value"),

                        (try_begin),
                            (eq, ":value", 0),
                            (assign, "$g_filter_center", spt_village),
                        (else_try),
                            (eq, ":value", 1),
                            (assign, "$g_filter_center", spt_castle),
                        (else_try),
                            (eq, ":value", 2),
                            (assign, "$g_filter_center", spt_town),
                        (else_try),
                            (eq, ":value", 3),
                    ...
                    (else_try),
                        (eq, ":object", "$g_presentation_filter_lord"),

                        (assign, ":cur_value", 0),
                        (assign, ":end", centers_end),
                        (try_for_range_backwards, ":cur_center", centers_begin, ":end"),
                            (call_script, "script_cf_clan_management_can_display_center", ":cur_center"),
                        ...
                        (else_try),
                            (neq, ":end", 0),
                            (assign, "$g_filter_lord", filter_none),
                        (try_end),
                        (start_presentation, "prsnt_clan_management"),
                    (else_try),
                        (eq, ":object", "$g_presentation_filter_governor"),
                        ...
                        (try_for_range_backwards, ":cur_center", centers_begin, ":end"),
                            ...
                            (try_begin),
                                ...
                                (try_begin),
                                    ...
                                    (assign, ":end", 0),
                                    (assign, "$g_filter_governor", ":governor"),
                                (try_end),
                            (try_end),
                        (try_end),
                        (try_begin),
                        ...
                        (else_try),
                            (neq, ":end", 0),
                            (assign, "$g_filter_governor", filter_none),
                        (try_end),
                        (start_presentation, "prsnt_clan_management"),
                    (else_try),
                ...
                [
                    ...
                    (try_for_range_backwards, ":building", center_buildings_begin, center_buildings_end),
                        ...
                        (else_try),
                            ...
                            (try_begin),
                                (call_script, "script_cf_party_has_building", ":current_center", ":requirement"),
                                (assign, ":has_building", 1),
                            (try_end),
                            (eq, ":has_building", 0),
                            (str_store_item_name, s11, ":requirement"),
                            (str_store_string, s10, "@Requires^{s11}"),
        ...
        [
            (ti_on_presentation_load,
                [
                    ...
                    (try_begin),
                        (store_add, ":x", ":header_name_x", -150),
                        # If player can update multiple characters
                        (create_image_button_overlay, "$g_presentation_previous", "mesh_small_arrow_down", "mesh_small_arrow_down_clicked"),
                        (position_set_x, pos1, ":x"),
                        (position_set_y, pos1, 700),
                        (overlay_set_position, "$g_presentation_previous", pos1),
                        (position_set_x, pos1, 250),
                        (position_set_y, pos1, 250),
                        (overlay_set_size, "$g_presentation_previous", pos1),

                        (store_add, ":x", ":header_name_x", 150),
                        (create_image_button_overlay, "$g_presentation_next", "mesh_small_arrow_up", "mesh_small_arrow_up_clicked"),
                        (position_set_x, pos1, ":x"),
                        (position_set_y, pos1, 700),
                        (overlay_set_position, "$g_presentation_next", pos1),
                        (position_set_x, pos1, 250),
                        (position_set_y, pos1, 250),
                        (overlay_set_size, "$g_presentation_next", pos1),
                    (try_end),
            ...
            (ti_on_presentation_event_state_change,
                [
                    ...
                    (else_try),
                        ...
                        (assign, ":update", 1),
                    (else_try),
                        (eq, ":object", "$g_presentation_next"),
                        (assign, ":next", 0),
                        (try_begin),
                            (eq, ":current_troop", "$g_player_troop"),
                            (assign, ":next", 1),
                        (try_end),
                        (assign, ":end", npc_heroes_end),
                        (try_for_range, ":cur_npc", npc_heroes_begin, ":end"),
                            (call_script, "script_cf_troop_can_player_update_skills", ":cur_npc"),
                            (try_begin),
                                (eq, ":next", 1),
                                (assign, ":end", 0),
                                (assign, "$temp", ":cur_npc"),
                        ...
                        (try_end),
                    (else_try),
                        (eq, ":object", "$g_presentation_previous"),
                        (assign, ":previous", "$g_player_troop"),
                        (assign, ":end", npc_heroes_end),
                        (try_for_range, ":cur_npc", npc_heroes_begin, ":end"),
                            (call_script, "script_cf_troop_can_player_update_skills", ":cur_npc"),
                            (try_begin),
                                ...
                                (assign, ":end", 0),
                            (else_try),
                                (assign, ":previous", ":cur_npc"),
                            (try_end),
                        (try_end),
                        (assign, "$temp", ":previous"),
                        (start_presentation, "prsnt_character_screen"),
                    (else_try),
                        (eq, ":object", "$g_presentation_ok"),
                        (presentation_set_duration, 0),
