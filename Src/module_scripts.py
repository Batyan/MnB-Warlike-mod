...
scripts = [ 
        ...
        [
            ...
            (try_for_range, ":party_no", centers_begin, centers_end),
                ...
                (else_try),
                    ...
                    (assign, ":value", 1),
                (try_end),
                (faction_get_slot, ":num_fiefs", ":party_faction", slot_faction_num_fiefs),
                (val_add, ":num_fiefs", ":value"),
                (faction_set_slot, ":party_faction", slot_faction_num_fiefs, ":num_fiefs"),
            (try_end),
            ...
            (try_for_range, ":merchant", merchants_begin, merchants_end),
                (troop_set_slot, ":merchant", slot_troop_last_met, -680), # Around 4 weeks' worth of goods
            (try_end),
            
            (party_set_slot, "p_main_party", slot_party_leader, "trp_player"),
    ...
    ("party_group_defeat_party_group",
        [
            ...
            (party_get_num_attached_parties, ":num_defeated", ":defeated_party"),
            (val_add, ":num_defeated", 1),
            (val_mul, ":num_defeated", war_damage_base_lord_defeated),
            ...
            # /!\ Defeated_party should be considered no longer referenced! /!\
            ...
            (try_begin),
                ...
                (try_for_range, ":attached_party_rank", 0, ":num_attached_parties"),
                    ...
                    (gt, ":attached_party", 0),
                    (call_script, "script_party_process_mission", ":attached_party"),
            ...
            (try_begin),
                ...
                (try_for_range, ":attached_party_rank", 0, ":num_attached_parties"),
                    ...
                    (try_for_range_backwards, ":unused", 0, ":num_per_party"),
                        ...
                        (store_random_in_range, ":rand", 0, ":num_stacks"),
                        (party_stack_get_troop_id, ":troop_id", ":prisoner_party", ":rand"),
                        (party_add_prisoners, ":attached_party", ":troop_id", 1),
                        (party_remove_members, ":prisoner_party", ":troop_id", 1),
                    (try_end),
                (try_end),
            (try_end),
    ...
    ("game_event_buy_item",
        [
            ...
            # (assign, reg10, ":value"),
            # (display_message, "@You are levied of {reg10} denars in tax."),
        ]),
    ...
    ("game_event_sell_item",
        [
            # ToDo: selling tax (taken on merchant)
            # (try_begin),
            ...
            #     (troop_remove_gold, "$current_trader", ":value"),
            # (try_end),
        ]), 
    ...
    ("game_get_troop_wage",
        [
            ...
            (try_begin), # 5% less per leadership point
                ...
                (store_sub, ":percentage", 100, ":leadership"),
                (val_mul, ":troop_level", ":percentage"),
                (val_div, ":troop_level", 100),
            (try_end),
        ...
        [
            ...
            (else_try),
                ...
                (try_begin),
                    ...
                    (str_store_faction_name, s21, ":troop_faction"),
...
##  # OUTPUT: trigger_result = multiplier (scaled by 100, meaning that giving 100 as the trigger result does not change the party speed)
    ...
    ("process_battle_ais",
        [
            ...
            # (try_for_range, ":cur_team", 1, 2), # ToDo: player control
                ...
                # (call_script, "script_process_team_battle_reinforcement_ai", ":cur_team"),
            (try_end),
        ]),
        ...
        [
            ...
            (else_try),
                ...
                (try_begin),
                    ...
                    (team_give_order, ":team_no", grc_other, mordr_charge),
    ...
    # script_process_team_battle_reinforcement_ai
    # input:
    #   arg1: team_no
    # output: none
    ("process_team_battle_reinforcement_ai",
        [
            # (store_script_param, ":team_no", 1),
        ]),
    ...
    ("party_process_population",
        [
            ...
            (store_div, ":population_growth", ":party_population", 200),
    ...
    ("init_factions_troop_ratio",
        [
            ...
            (faction_set_slot, "fac_kingdom_4", slot_faction_troop_ratio_cavalry, 15),
    ...
    ("faction_declare_war_to_faction",
        [
            ...
            (try_for_range, ":faction_no", kingdoms_begin, kingdoms_end),
                ...
                (neq, ":faction_no", ":faction_2"),
                (store_relation, ":relation_1", ":faction_no", ":faction_1"),
                (store_relation, ":relation_2", ":faction_no", ":faction_2"),
                ...
                (else_try),
                    (ge, ":relation_1", relation_defensive),
                    (gt, ":relation_2", relation_war),
                    (try_begin),
                        (call_script, "script_cf_debug", debug_faction|debug_simple),
                    ...
                    (call_script, "script_faction_declare_war_to_faction", ":faction_no", ":faction_2"),
                (else_try),
                    (ge, ":relation_2", relation_defensive),
                    (gt, ":relation_1", relation_war),
                    (try_begin),
                        (call_script, "script_cf_debug", debug_faction|debug_simple),
                    ...
                    (call_script, "script_faction_declare_war_to_faction", ":faction_no", ":faction_1"),
                (else_try),
                    (ge, ":relation_1", relation_friendly),
                    (gt, ":relation_2", relation_war),
                    ...
                    (call_script, "script_faction_declare_war_to_faction", ":faction_no", ":faction_2"),
                (else_try),
                    (ge, ":relation_2", relation_friendly),
                    (gt, ":relation_1", relation_war),
    ...
    ("spawn_lord",
        [
            ...
            (try_begin),
                ...
                (call_script, "script_party_process_mission", ":party"),
    ...
    ("party_visit_center",
        [
            ...
            (try_begin),
                ...
                (party_get_slot, ":leader", ":party_no", slot_party_leader),
                (party_slot_eq, ":center_no", slot_party_leader, ":leader"),
                ...
                (try_for_range, ":cur_stack", 0, ":num_prisoner_stacks"),
                    ...
                    (party_remove_prisoners, ":party_no", ":prisoner_troop_id", ":stack_size"),
                    (assign, ":removed", reg0),
                    (gt, ":removed", 0),
                    (party_add_prisoners, ":center_no", ":prisoner_troop_id", ":stack_size"),
                (try_end),
            (try_end),
        ]),
            ...
            (else_try),
                ...
                (try_begin),
                    ...
                    (try_begin),
                        ...
                        (assign, ":stop", 1),
                    (else_try),
                        (store_div, ":lower_party_limit", ":party_combat_limit", 3),
    ...
    ("party_give_troops_to_party",
        [
            ...
            (party_get_slot, ":party_type", ":receiver_party", slot_party_type),
            (try_begin),
                (eq, ":party_type", spt_war_party),
                ...
                (try_begin),
                    ...
                    (call_script, "script_party_give_troops_to_party_priority", ":giver_party", ":receiver_party", ":num_troops", -1),
                    (val_add, ":num_added", reg0),
                    (val_add, ":total_cost", reg1),
                (else_try),
                    ...
                    (try_end),
                    (call_script, "script_party_give_troops_to_party_priority", ":giver_party", ":receiver_party", ":num_troops", ":priority"),
                    (val_add, ":num_added", reg0),
                    (val_add, ":total_cost", reg1),
                (try_end),
            (else_try),
                # (eq, ":party_type", spt_convoy),
                (call_script, "script_party_give_troops_to_party_priority", ":giver_party", ":receiver_party", ":num_troops", tq_veteran),
                (val_add, ":num_added", reg0),
                (val_add, ":total_cost", reg1),
            # (else_try),
                # (call_script, "script_party_give_troops_to_party_priority", ":giver_party", ":receiver_party", ":num_troops", 10),
            (try_end),
                ...
                (try_begin),
                    ...
                    (try_begin),
                        ...
                        (try_for_range, ":other_slot", slot_troop_married_to, slot_troop_child_10+1),
                            ...
                            (neg|troop_slot_eq, ":other_relative", slot_troop_kingdom_occupation, tko_dead),
    ...
    ("init_troops_mercenary",
        [
            ...
            (troop_set_slot, "trp_sarranid_light_infantry", slot_troop_mercenary_captain_1, "trp_sarranid_guard"),
    ...
    # script_party_update_merchants_old
    # input:
    #   arg1: party_no
    # output: none
    # ("party_update_merchants_old",
    #     [
    #         (store_script_param, ":party_no", 1),
    ...
    ("faction_process_foreign_politics",
        [
            ...
            (try_for_range, ":other_faction", kingdoms_begin, kingdoms_end),
                ...
                (else_try),
                    (ge, ":rel", relation_defensive),
                    (faction_get_slot, ":ally_wars", ":other_faction", slot_faction_is_at_war),
                    # Process whether to help defensive allies (less likely then allies and not automatic when ally declares war)
                (else_try),
                    (ge, ":rel", relation_friendly),
                    # Process whether to make a trade treaty, or, if already have one, a defensive alliance
                (else_try),
    ...
    ("party_besiege_party",
        [
            ...
            (try_begin),
                ...
                (this_or_next|ge, ":leader", 0),
                (eq, ":attacker", "p_main_party"),
                (val_max, ":leader", 0),
    ...
    ("party_capture_center",
        [
            ...
            (try_end),
            (faction_get_slot, ":num_fiefs_old_faction", ":old_center_faction", slot_faction_num_fiefs),
            (val_sub, ":num_fiefs_old_faction", ":value"),
            (faction_set_slot, ":old_center_faction", slot_faction_num_fiefs, ":num_fiefs_old_faction"),
            
            (faction_get_slot, ":num_fiefs_new_faction", ":party_faction", slot_faction_num_fiefs),
            (val_add, ":num_fiefs_new_faction", ":value"),
            (faction_set_slot, ":party_faction", slot_faction_num_fiefs, ":num_fiefs_new_faction"),
            ...
            (call_script, "script_center_change_faction", ":center_no", ":party_faction"),
        ]),
    ...
    ("center_change_faction",
        [
            ...
            #     (else_try),
            #         (eq, ":center_faction", ":old_faction"),
            #         (val_add, ":old_faction_weight", ":center_weight"),
            #     (try_end),
            # (try_end),
            ...
            # (call_script, "script_get_faction_size_from_weight", ":old_faction_weight"),
            # (assign, ":old_faction_new_size", reg0),

            # (faction_get_slot, ":new_faction_old_size", slot_faction_size, ":new_faction"),
            # (faction_get_slot, ":old_faction_old_size", slot_faction_size, ":old_faction"),
            ...
            # (try_end),
            # (try_begin),
            #     (neq, ":old_faction_old_size", ":old_faction_new_size"),
            #     (faction_set_slot, ":old_faction", slot_faction_size, ":old_faction_new_size"),
            #     (call_script, "script_faction_update_name", ":old_faction"),
            # (try_end),
        ]),
    ...
    ("faction_damage_faction",
        [
            ...
            (call_script, "script_transform_war_damage_to_relation_change", ":damage_amount"),
            (assign, ":relation_damage", reg0),
            (call_script, "script_faction_change_relation_with_faction", ":receiving_faction", ":dealing_faction", ":relation_damage"),
    ...
    ("faction_change_relation_with_faction",
        [
            ...
            (store_relation, ":current_relation", ":faction_1", ":faction_2"),
            (store_add, ":new_relation", ":current_relation", ":relation_change"),
            
            (assign, ":change", 0),
            # Make checks to change relation state
            (try_begin),
                (le, ":current_relation", relation_war),
                (try_begin),
                    (gt, ":new_relation", relation_war),
                    (assign, ":new_relation", relation_war),
                (try_end),
            (else_try),
                (is_between, ":current_relation", relation_war, relation_economic),
                (try_begin),
                    (le, ":new_relation", relation_war),
                    (assign, ":new_relation", relation_war+1),
                (else_try),
                    (ge, ":new_relation", relation_economic),
                    (assign, ":new_relation", relation_economic-1),
                (try_end),
            (else_try),
                (ge, ":current_relation", relation_allies),
                (try_begin),
                    (lt, ":new_relation", relation_allies),
                    (assign, ":new_relation", relation_allies),
                (try_end),
            (else_try),
                (ge, ":current_relation", relation_defensive),
                (try_begin),
                    (lt, ":new_relation", relation_defensive),
                    (assign, ":new_relation", relation_defensive),
                (else_try),
                    (ge, ":new_relation", relation_allies),
                    (assign, ":new_relation", relation_allies-1),
                (try_end),
            (else_try),
                (ge, ":current_relation", relation_economic),
                (try_begin),
                    (lt, ":new_relation", relation_economic),
                    (assign, ":new_relation", relation_economic),
                (else_try),
                    (ge, ":new_relation", relation_defensive),
                    (assign, ":new_relation", relation_defensive-1),
                (try_end),
            (try_end),
            (store_sub, ":change", ":new_relation", ":current_relation"),
            ...
            (try_begin),
                ...
                (display_message, "@{s10} and {s11} relation{reg10}, political event {reg0?ignored:occuring}"),
            (try_end),
            
            (val_clamp, ":new_relation", -100, 100),
            (try_begin),
    ...
    ("party_spawn_bandits",
        [
            ...
            # Determine bandit strength on center prosperity
            (store_random_in_range, ":bandit_strength", 1, 4),
            # High prosperity will increase the strength of bandits
            ...
            (store_add, ":total1", ":plain_bandit", ":forest_bandit"),
            (store_add, ":total2", ":mountain_bandit", ":tundra_bandit"),
            (store_add, ":total3", ":steppe_bandit", ":desert_bandit"),
            (store_add, ":grand_total", ":sea_raiders", ":total1"),
            (val_add, ":grand_total", ":total2"),
            (val_add, ":grand_total", ":total3"),
    ...
    ("troop_freed",
        [
            ...
            (try_begin),
                ...
                (str_store_troop_name, s10, ":troop_id"),
                (str_store_party_name, s11, ":party_no"),
                (display_message, "@{s10} has been freed by {s11}."),
            (try_end),
        ]),
    ...
    ("party_get_wages", 
        [
            ...
            (try_begin), # 5% less per leadership point
                ...
                (val_mul, ":leadership", 5),
                (store_sub, ":percentage", 100, ":leadership"),
                (val_mul, ":party_wages", ":percentage"),
