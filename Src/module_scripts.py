...
scripts = [ 
    ...
    ("game_start",
        [
            ...
            (troop_set_slot, "$g_player_troop", slot_troop_renown, 50),
    ...
    ("troop_get_center_keeper_score",
        [
            ...
            (try_begin),
                ...
                # (ge, ":relation", 0),
                (store_add, ":multiplier", ":relation", 100),
    ...
    ("troop_get_relation_with_troop",
        [
            ...
            (try_begin),
                (gt, ":target_troop", npc_heroes_begin),
