...
factions = [
	...
	("small_kingdom_23", "Rivacheg", 0, 0.9, [("outlaws",-0.5),], [], 0x466346), # Footman + Heavy Footman + Warrior + Knight
	("small_kingdom_24", "Yruma", 0, 0.9, [("outlaws",-0.5),], [], 0x88dd88), # Light Skirmisher + Heavy Skirmisher + Champion + Royal Skirmisher
	("small_kingdom_25", "the Southern Taiga", 0, 0.9, [("outlaws",-0.5),], [], 0x885500), # Pikeman + Heavy Pikeman + Scout + Heavy Mounted Longbowman + Mounted Longbowman + Longbowman + Royal Longbowman
