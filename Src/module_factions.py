...
factions = [
	...
	("small_kingdom_14", "County of Gisim", 0, 0.9, [("outlaws",-0.5),], [], 0x660044), # Light Longbowman + Longbowman + Hunter
	...
	("small_kingdom_21", "County of Slezhk", 0, 0.9, [("outlaws",-0.5),], [], 0x554400), # Royal Lancer + Heavy Lancer + Levy Axeman + Hussar + Heavy Hussar
	("small_kingdom_22", "County of Khudan", 0, 0.9, [("outlaws",-0.5),], [], 0x005500), # Scout + Club Levy + Horseman + Royal Horseman + Light Club Infantry + Club Infantry + Heavy Club Infantry
	...
	("small_kingdom_31", "Eastern Tribes", 0, 0.9, [("outlaws",-0.5),], [], 0xbb88bb), # Champion + Noble Rider + Tribal Infantry? + Tribal Light Archer? + Tribal Archer?
	...
	("small_kingdom_36", "Tribes of Azugan", 0, 0.9, [("outlaws",-0.5),], [], 0x440044), # Heavy Archer + Blade-master + Heavy Infantry + Levy Infantry
	...
	("small_kingdom_42", "Gundig Warriors", 0, 0.9, [("outlaws",-0.5),], [], 0x2f8558), # Heavy Longbowman + Light Longbowman + Light Infantry + Heavy Infantry
	...
	("small_kingdom_52", "Bezan Community", 0, 0.9, [("outlaws",-0.5),], [], 0x00255e), # Heroic Horseman + Levy Pikeman + Heavy Horseman + Light Horseman? + Heroic Pikeman
	("small_kingdom_53", "City of Veluca", 0, 0.9, [("outlaws",-0.5),], [], 0x368afd), # Light Cavalry + Heavy Cavalry + Heroic Cavalry
	("small_kingdom_54", "City of Jamiche", 0, 0.9, [("outlaws",-0.5),], [], 0xBE9EFF), # Light Spearman + Light Skirmisher + Heavy Spearman + Mounted Crossbow + Heavy Mounted Crossbow + Heroic Mounted Crossbow + Levy Crossbow
	("small_kingdom_55", "Saren Community", 0, 0.9, [("outlaws",-0.5),], [], 0x6755db), # Mounted Crossbow + Heavy Lancer + Heroic Lancer + Scout + Levy Crossbow
	
	("small_kingdom_61", "Oasis of Barriye", 0, 0.9, [("outlaws",-0.5),], [], 0x804303), # Light Crossbowman + Levy Horseman + Crossbowman + Noble Horseman?
