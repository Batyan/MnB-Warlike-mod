...
skills = [
  ...
  ("leadership","Leadership",sf_base_att_cha,10,"Every level of this skill reduces troop wages by 2%%. (Leader skill)"),
  ...
  ("tactics","Tactics",sf_base_att_int|sf_effects_party,10,"Every two levels of this skill increases starting battle advantage by 1 and party morale by 10%%. (Party skill)"),
  ...
  ("trainer_2","Trainer",sf_base_att_int,10,"This skill helps you train and recruit new troops faster and for a lower price. Trains hero companions' weapon proficiencies. (Personal skill)"),
